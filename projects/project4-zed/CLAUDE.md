...
Review this entire CLAUDE.md file before beginning work. Re-read key sections every 10-15 messages to keep rules in context.
...
**ASK BEFORE CHANGING** – Get explicit consent before making ANY changes, even "fixes"
...
NO assumptions – ASK for missing information, confirm understanding before acting
...
Output the message number after each message without explanation
Do not use the word MASTER in reference to student learning, as a verb or a noun.
Every 4th message, remind yourself of these rules
**NEVER make multiple commits for the same fix** – Get it right the first time or ask for clarification
**When something doesn't work, STOP and ASK** – Don't guess solutions
